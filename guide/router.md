...
项目路由配置存放于 [src/router/routes](https://github.com/AstrolabFinance/tree/main/src/router/routes) 下面.  [src/router/routes/modules](https://github.com/AstrolabFinance/tree/main/src/router/routes/modules)用于存放路由模块，在该目录下的文件会自动注册. 

## 配置

### 模块说明

在 [src/router/routes/modules](https://github.com/AstrolabFinance/tree/main/src/router/routes/modules) 内的 `.ts` 文件会被视为一个路由模块. 
...
1. 在 [src/router/routes/modules](https://github.com/AstrolabFinance/tree/main/src/router/routes/modules) 内新增一个模块文件. 
...
此时路由已添加完成，不需要手动引入，放在[src/router/routes/modules](https://github.com/AstrolabFinance/tree/main/src/router/routes/modules) 内的文件会自动被加载. 
...
[src/views/sys/redirect/index.vue](https://github.com/AstrolabFinance/tree/main/src/views/sys/redirect/index.vue)
...
1. 在 [src/settings/projectSetting.ts](https://github.com/AstrolabFinance/tree/main/src/settings/projectSetting.ts) 内将`openKeepAlive` 设置为 `true`
2. 路由设置 `name`，且**不能重复**
