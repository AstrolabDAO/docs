...
详细代码见 [src/router/guard/permissionGuard.ts](https://github.com/AstrolabFinance/tree/main/src/router/guard/permissionGuard.ts)
...
**permissionStore.buildRoutesAction** 用于**过滤动态路由**，详细代码见 [src/store/modules/permission.ts](https://github.com/AstrolabFinance/tree/main/src/store/modules/permission.ts)
...
系统提供 [usePermission](https://github.com/AstrolabFinance/tree/main/src/hooks/web/usePermission.ts) 方便角色相关操作
...
[usePermission](https://github.com/AstrolabFinance/tree/main/src/hooks/web/usePermission.ts) 还提供了按钮级别的权限控制. 
...
**permissionStore.buildRoutesAction** 用于**过滤动态路由**，详细代码见 [/@/store/modules/permission.ts](https://github.com/AstrolabFinance/tree/main/src/store/modules/permission.ts)
...
if (permissionMode === PermissionModeEnum.BACK) {
  ...
  // Dynamically Get started components
