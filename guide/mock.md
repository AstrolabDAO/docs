...
[.env.development](https://github.com/AstrolabFinance/tree/main/.env.development) 文件配置
...
生产环境接口地址在项目根目录下 [.env.production](https://github.com/AstrolabFinance/tree/main/.env.production) 文件配置. 
...
接口统一存放于 [src/api/](https://github.com/AstrolabFinance/tree/main/src/api) 下面管理
...
**axios** 请求封装存放于 [src/utils/http/axios](https://github.com/AstrolabFinance/tree/main/src/utils/http/axios) 文件夹内部
...
当项目中需要用到多个接口地址时, 可以在 [src/utils/http/axios/index.ts](https://github.com/AstrolabFinance/tree/main/src/utils/http/axios/index.ts) 导出多个 axios 实例
...
本项目使用 [vite-plugin-mock](https://github.com/astrolabjs/vite-plugin-mock) 来进行 mock 数据处理. **项目内 mock 服务分本地和线上**. 
...
可在 [代码](https://github.com/AstrolabFinance/tree/main/mock/_util.ts) 中查看
...
2. 在 [mock/\_createProductionServer.ts](https://github.com/AstrolabFinance/tree/main/mock/_createProductionServer.ts) 文件中引入需要的 mock 文件
...
3. 在 [build/vite/plugin/mock.ts](https://github.com/AstrolabFinance/tree/main/build/vite/plugin/mock.ts) 里面引入
