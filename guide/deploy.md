...
当然，你也可以使用精简版 [vue-astrolab-admin-thin](https://github.com/astrolabjs/astrolab-admin-thin-next) 进行开发. 
...
可在 [src/router/index.ts](https://github.com/AstrolabFinance/tree/main/src/router/index.ts) 内进行 mode 修改
